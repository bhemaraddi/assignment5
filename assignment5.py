...
class student:
    ...
    def getRollNumber(self):
        if self.__rollnumber==201:
            print("yes its crt roll number",self.__rollnumber)
        else:
            print("incorrect rollnumber")    
result=student()  
result.setName("sachin","bheem")     
result.setRollNumber(201,"uttam")
result.getName()
...
class Savaccount(account):
    def __init__(self, title,balance,interest):
        ...
        print(self.interest)
result=Savaccount("sachin",5000,5) 
